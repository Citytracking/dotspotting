			...
			(function() {
				...
				engine.geoJson = function(container, cue) {
                    ...
                    function onload(collection) {
                        ...
                        if (setExtent) {
                            _layer.map.setExtent(locations);
                        }
                        if (enforceBounds) {
                            // TODO: _layer.provider.setBounds(locations);
                        }
                    }
                    ...
                    var enforceBounds = false;
                    layer.enforceBounds = function(x) {
                        if (arguments.length) {
                            enforceBounds = x;
                            return layer;
                        } else {
